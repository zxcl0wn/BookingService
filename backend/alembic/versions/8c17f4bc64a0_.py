...
Revision ID: 8c17f4bc64a0
Revises: 005c754267d8
Create Date: 2026-04-17 18:00:16.298385
...
revision: str = '8c17f4bc64a0'
down_revision: Union[str, Sequence[str], None] = '005c754267d8'
...
def downgrade() -> None:
    ...
    sa.Column('booking_code', sa.VARCHAR(), nullable=False),
    ...
    sa.Column('user_id', sa.INTEGER(), nullable=False),
    sa.Column('room_id', sa.INTEGER(), nullable=False),
    sa.Column('booking_code', sa.INTEGER(), nullable=False),
